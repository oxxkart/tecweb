	...
	<tbody>
		<?php
				foreach ($data as $key => $value) {
					...
					echo '<td><img src=' . $value['imagen'] . ' width="100px" height="100px" /></td>';
					echo "<td><input type='submit' name='Submit' value='submit' formaction='http://localhost:83/Tecnologiasweb/tecweb/practicas/p08/formulario_productos_v3.php' /></td>";
					echo '</tr>';
				}
				?>
				</tbody>
